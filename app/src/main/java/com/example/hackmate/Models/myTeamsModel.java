...
public class myTeamsModel {
    ...
    private String TeamName, HackName,TeamPosition,Domain;
    //private int nextFragment;
    private String Domain1,Domain2,Domain3,Domain4,Domain5;


    public myTeamsModel(String teamName, String hackName, String teamPosition, String domain1, String domain2, String domain3, String domain4, String domain5) {
        TeamName = teamName;
        HackName = hackName;
