...
public class ProjectAdapterRT extends RecyclerView.Adapter<ProjectAdapterRT.Viewholder> {

    private Context context;
    private ArrayList<ProjectModel> projectModelArrayList;

    public ProjectAdapterRT(Context context, ArrayList<ProjectModel> projectModelArrayList) {
    ...
    @NonNull
    @Override
    public ProjectAdapterRT.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.projects_row, parent, false);
        return new ProjectAdapterRT.Viewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ProjectAdapterRT.Viewholder holder, int position) {
