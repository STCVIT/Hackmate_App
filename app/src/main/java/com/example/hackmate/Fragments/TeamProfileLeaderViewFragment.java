...
// here we have created new array list and added data to it.
        ...
        call1.enqueue(new Callback<teamIdPOJO>() {
            ...
            public void onResponse(Call<teamIdPOJO> call1, Response<teamIdPOJO> response1) {
                ...
                for(int i=0;i<member_objs2.size();i++)
                {
                    if(member_objs2.get(i).participant.get_id().equals(teamIdPOJOS.team1.getAdminId()))
                        continue;
                    members.add(member_objs2.get(i).participant.get_id());
